...
<body>
    ...
    <table class="header-table">
        <tr>
            <td class="logo-cell">
                <div class="logo">
                    <img src="http://localhost/rework/mohita_forwarders/img/pdf%20logo.jpg">
                </div>
            </td>

            <td class="company-cell">
                <div class="company-name">MOHITA FORWARDERS</div>
            ...
            <td class="contact-cell"><br>
                No 7A NGO Colony,<br><br>
                1St street, pazhavanthangal<br><br>
                Chennai-600114. Mob:044-22241022<br><br>
        ...
        <tr class="row-3">
            ...
            <td class="col-center booking-details-container">
                <table class="booking-details-table">
                    ...
                    <tr>
                        <td><?php echo htmlspecialchars($booking['no_packets']); ?></td>
                        <td><?php echo htmlspecialchars($booking['packing_type']); ?></td>
                        <td><?php echo htmlspecialchars($booking['actual_weight']); ?></td>
                        <td><?php echo htmlspecialchars($booking['charged_weight']); ?></td>
